...
function getApiBase() {
  // Vercel prod/preview: https://<deployment>
  if (process.env.VERCEL_URL) return `https://${process.env.VERCEL_URL}`;

  // Local dev fallback (node)
        ...
        <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">
              Grüntech Solar{" "}
              <span className="text-cyan-300">Akıllı Enerji Yönetim Modeli</span>
            </h1>
              ...
              <div className="relative space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3 text-xs">
                  ...
                  <div className="rounded-2xl bg-black/30 p-3 border border-white/10">
                    ...
                    <div className="mt-1 text-[11px] text-violet-300">3 fazlı tesis</div>
                  </div>
                </div>
                <p className="text-[11px] text-slate-400">
                  Aşağıdaki listeden bir tesisi seçin, detaylı enerji akış ekranına geçin.
                </p>
              </div>
            </div>
